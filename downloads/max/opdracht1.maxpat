...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 92.0, 461.0, 381.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 726.0, 392.0, 67.0, 22.0 ],
					"text" : "peakamp~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 640.0, 392.0, 37.0, 22.0 ],
					"text" : "avg~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 92.0, 487.0, 105.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 411.0, 284.0, 73.0, 22.0 ],
					"text" : "mousestate"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 411.0, 251.0, 59.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 92.0, 300.0, 170.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 92.0, 188.0, 65.0, 22.0 ],
					"text" : "qmetro 40"
				}
