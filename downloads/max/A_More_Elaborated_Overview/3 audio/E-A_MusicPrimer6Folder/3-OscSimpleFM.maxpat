...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 842.25, 393.0, 268.0, 23.0 ],
					"text" : "determines amplitude of modulating signal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 812.75, 248.0, 313.0, 41.0 ],
					"text" : "<<< program/modulator frequency\n(you can adjust this for non-harmonic modulation)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 751.25, 185.0, 345.0, 40.0 ],
					"text" : "determines the ratio of the modulating (or program) oscillator frequency compared to the carrier frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 393.0, 268.0, 23.0 ],
					"text" : "determines amplitude of modulating signal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 248.0, 313.0, 41.0 ],
					"text" : "<<< program/modulator frequency\n(you can adjust this for non-harmonic modulation)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 306.25, 185.0, 345.0, 40.0 ],
					"text" : "determines the ratio of the modulating (or program) oscillator frequency compared to the carrier frequency"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 698.25, 317.0, 42.0, 23.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 698.25, 286.0, 46.0, 21.0 ],
					"text" : "$1 50"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 727.5, 131.0, 180.0, 23.0 ],
					"text" : "program oscillator 2 settings"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 288.0, 131.0, 180.0, 23.0 ],
					"text" : "program oscillator 1 settings"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 698.25, 185.0, 49.0, 23.0 ],
					"text" : "bondo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 698.25, 215.0, 49.0, 23.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 820.75, 363.0, 60.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 727.5, 154.0, 55.75, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 698.25, 248.0, 86.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 710.25, 342.0, 101.0, 23.0 ],
					"text" : "program osc. 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 819.75, 342.0, 130.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 698.25, 393.0, 141.5, 23.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 698.25, 363.0, 62.0, 23.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 789.5, 154.0, 112.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 785.25, 248.0, 29.0, 23.0 ],
					"text" : "Hz"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.488525, 696.25, 38.0, 21.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 274.0, 468.0, 372.0, 27.0 ],
					"text" : "combined program signal modulates the carrier oscillator"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 707.75, 425.0, 395.0, 425.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 208.5, 127.0, 707.75, 127.0 ],
					"source" : [ "obj-22", 0 ]
				}
