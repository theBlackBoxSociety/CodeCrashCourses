...
- [3. Arduino→Max: An Analog Input (potentiometer) to be transferred to Max](#3-arduinomax-an-analog-input-potentiometer-to-be-transferred-to-max)
	...
	- [Notes on the Max code:](#notes-on-the-max-code)
		- [Sel Object](#sel-object)
		- [Zl Group Object](#zl-group-object)
		- [Itoa Object](#itoa-object)
		- [Fromsymbol Object](#fromsymbol-object)
...
- [6. Arduino→Max: Analog & Digital Inputs to Max](#6-arduinomax-analog-digital-inputs-to-max)
	- [alternative is Andrew Benson's SensorBox](#alternative-is-andrew-bensons-sensorbox)
